...
public class PreControllerFilter implements Filter {
    ...
    public void init(FilterConfig config) throws ServletException {
        ...
        customerCommands = Set.of(LOGOUT_COMMAND, DEFAULT_COMMAND, GO_TO_MAIN_PAGE_COMMAND,
                ...
                GO_TO_ORDER_FORM, ADD_ORDER_COMMAND, GO_TO_USER_ORDERS_PAGE, GO_TO_CHANGE_ORDER_PAGE,
                INACTIVATE_ORDER_COMMAND, CHANGE_LANGUAGE_COMMAND);
        ...
        adminCommands = Set.of(LOGOUT_COMMAND, DEFAULT_COMMAND, FIND_ALL_USERS_COMMAND, GO_TO_MAIN_PAGE_COMMAND,
                ...
                INACTIVATE_CAR_COMMAND, GO_TO_INACTIVATE_CAR_PAGE_COMMAND, GO_TO_ORDER_FORM, ADD_ORDER_COMMAND,
                GO_TO_USER_ORDERS_PAGE, GO_TO_CHANGE_ORDER_PAGE, INACTIVATE_ORDER_COMMAND, FIND_ALL_ORDERS_COMMAND,
                GO_TO_CONFIRM_ORDERS_PAGE, CONFIRM_ORDER_COMMAND, GO_TO_CANCEL_ORDERS_PAGE, CANCEL_ORDER_COMMAND,
                GO_TO_COMPLETE_ORDERS_PAGE, COMPLETE_ORDER_COMMAND, FIND_ALL_RETURN_FORMS_COMMAND,
                CHANGE_LANGUAGE_COMMAND);
