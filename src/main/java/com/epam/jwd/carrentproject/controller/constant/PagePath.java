...
public class PagePath {
    ...
    public static final String HOME_PAGE = "pages/common/home.jsp";
    ...
    public static final String CHANGE_PERSONAL_INFO_FORM = "pages/common/change_personal_info_form.jsp";
    public static final String CHANGE_PASSWORD_FORM = "pages/common/change_password_form.jsp";
    ...
    public static final String ORDER_FORM="pages/common/order_form.jsp";
    public static final String PAYMENT_FORM="pages/common/payment_form.jsp";
    public static final String USER_ORDERS_PAGE="pages/common/user_orders_page.jsp";
